...
import { PUBLIC_APP_URL, getSkillUrl } from '@/lib/runtime';
...
export default function Landing() {
  ...
  const [skillCommand, setSkillCommand] = useState(() =>
    PUBLIC_APP_URL ? `curl -s ${PUBLIC_APP_URL}/skill.md` : 'curl -s <your-app-url>/skill.md'
  );
      ...
      <div className="relative z-10 h-full flex">
        ...
        <div className="flex-1 flex flex-col justify-center px-16 lg:px-24">
          ...
          <div className="flex items-center mb-16">
            <Image src="/reforge-logo.png" alt="Reforge" width={140} height={32} className="h-8 w-auto" priority />
          </div>
            ...
            >
              ...
              <div className="relative h-full p-6 flex flex-col">
                ...
                <div className="flex items-center justify-between mb-4">
                  <Image src="/reforge-logo.png" alt="Reforge" width={72} height={16} className="h-4 w-auto" />
